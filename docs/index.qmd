...
Create an account with the [GW Coder's Slack](https://gwucoders.slack.com/) organization and join the `#ospo-workshops` channel, where we can chat about today's workshop, share links and resources, etc.
