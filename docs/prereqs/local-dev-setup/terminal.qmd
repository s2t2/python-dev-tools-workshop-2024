...
The choice of command line tool depends on your operating system:
  ...
  + Mac users who don't already have a preferred command-line application are encouraged to use the built-in Terminal application (no need to download anything, although you may want to optionally [customize the Terminal](./terminal-config.qmd) appearance as desired).
...
You should now also be able to use your command-line application to complete the ["Command-line Computing" Exercise](../../exercises/command-line-computing/index.qmd), which will introduce you to additional commands.
